...
API_ID = int(environ.get('API_ID', '25580827'))
API_HASH = environ.get('API_HASH', 'e7f398847755449564652e1e641a7fe4')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002332441526'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002269691404').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Subhadeepbarman04:Subhadeepbarman04@cluster0.4utss.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
